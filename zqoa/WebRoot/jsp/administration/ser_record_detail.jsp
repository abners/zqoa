            ...
            <div class="toolbar">
                ...
                <div id="toolbar-content">
                    <p class="crumb">
                        ...
                        <a href="javascript:void(0);">事物詳情</a>
                    </p>
            	...
            	<fieldset class="forms-area">
                    ...
                    <form action="addId" method="post" id="addId" class="add-form">
                    	...
                    	<table>
                   			...
                   			<tr>
                            	<th>登記人：</th>
                                <td><s:property value="serRecord.authorName"/></td>
                            </tr>
                        	<tr>
                            	<th>登記時間：</th>
                                <td>
                                <s:property value="serRecord.createTime"/>
                                </td>
                            </tr>

                            <th>公告内容：</th>
                                <td>
                                <s:property value="serRecord.content"/>
                                </td>
                            </tr>

							<tr>
                            	<th>&nbsp;</th>
                                <td><a class="btn-h28 ui-button" id="addContFile" href="listSerRecord.htm">返回事物列表</a></td>
                            </tr>
                        </table>
                </fieldset>
