		...
		<div id="main">
			...
			<div class="wrap">
				<fieldset class="forms-area">
					...
					<div class="list-form">
						<ec:table items="zqAnnounceList" var="row"
							action="listDeparts.htm" width="90%" autoIncludeParameters="false" showPagination="false">

							<ec:row highlightRow="true">

								<ec:column property="name" style="height:35px;text-align:center" title="标题"><a href="announceDetail.htm?asrId=${row.id }" title="查看详情">${row.title }</a>
								</ec:column>
								<ec:column property="authorName" style="height:35px;text-align:center" title="发布人">
								</ec:column>
								<ec:column property="cust_typeValue" escapeAutoFormat="true"
									style="text-align:center;height:35px;" title="操作">
									<a href="modifyAnnounceInit.htm?asrId=${row.id}" title="修改">修改</a>|<a href="${row.id}" title="删除">删除</a>
								</ec:column>
