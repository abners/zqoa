            	...
            	<fieldset class="forms-area">
                    ...
                    <input type="hidden" name="zqAsrModel.author" value="<s:property value="zqasr.author"/>">
                    	<table>
                   			...
                   			<tr>
                            	<th>事件名称：</th>
                                <td><s:property value="zqasr.name"/></td>
                            </tr>
                        	<tr>
                            	<th>事件类型：</th>
                                <td>
							...
							<tr>
                            	<th>事件内容：</th>
                                <td><s:property value="zqasr.content"/></td>
                            </tr>
							<tr>
                            	<th>&nbsp;</th>
                                <td><a class="btn-h28 ui-button" id="addContFile"
													href="listAsr.htm">返回登记列表</a>&nbsp;&nbsp;<a class="btn-h28 ui-button" id="addContFile"
													href="modifyAsrInit.htm?asrId=<s:property value="zqasr.id"/>">修改登记资料</a></td>
                            </tr>
                        </table>
                </fieldset>
