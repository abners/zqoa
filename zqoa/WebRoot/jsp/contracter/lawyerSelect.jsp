...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<div id="main">
			<div class="toolbar">
				...
				<div id="toolbar-content">
					<p class="crumb">
						<b>您的位置：</b>
						<a href="toIndex.htm">首页</a> ><a href="javascript:void(0);">律师承办查看</a>>
						...
						<ul style="padding:15px 30px">
							...
							<table>
								<tr>
									<th>选择律师：</th>
									<td>
										<select name="id" id="lawyersArray">
											<option value="-1">--请选择--</option>
										<s:iterator value="user">
											<option value="<s:property value="id"/>" <s:if test="userId==id">selected="selected"</s:if>><s:property value="name"/></option>
										</s:iterator>
										</select>
									</td>
								</tr>
	...
	$(document).ready(function(){
		$("#lawyersArray").change(function(){
			if($(this).val()!=-1){
				document.location.href="lawyerCase_Cont_See.htm?userId="+$(this).val();
			}else{
