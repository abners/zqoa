			...
			<div class="toolbar">
				...
				<div id="toolbar-content">
					<p class="crumb">
						...
						<a href="/zqoa/index.php/Customer/listExpiredCustomer.htm">客户管理</a> >
						...
						<ec:table items="zqCustomerModels" var="row"
							...
							<ec:row highlightRow="true">
								...
								<ec:column property="caozuo" style="text-align:center;"
									title="操作">
									<a href="modifyCustInit.htm?cust_id=${row.id}">修改</a>|<a href="javascript:void(0);" onclick="deltCust('${row.id}')" target="_self">删除</a>|<a href="javascript:void(0);" onclick="makeExpired('${row.id}')">归入现有客户</a>
								</ec:column>
...
function makeExpired(cust_id){
	if(confirm("是否确认要归入现有客户中?")){
		$.ajax({
			type : "post",
			url : "enableCustomer.htm",
			dataType : "json",
