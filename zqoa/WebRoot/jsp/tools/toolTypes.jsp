		...
		<div id="main">
			<div class="toolbar">
				...
				<div id="toolbar-content">
					<p class="crumb">
						...
						<a href="javascript:void(0);">案件类型</a>
					</p>
			...
			<div class="wrap">
				<fieldset class="forms-area">
					...
					<div class="list-form">
						<ec:table items="toolsTypeList" var="row"
							action="toolsTypeManage.htm" width="90%" autoIncludeParameters="false">

							<ec:row highlightRow="true">

								<ec:column property="identityName" style="height:35px;" title="工具类型">
								...
								<ec:column property="cust_typeValue" escapeAutoFormat="true"
									...
									<a href="javascript:void(0);" title="修改">修改</a>|<a href="${row.id}" title="删除">删除</a>
								</ec:column>
		...
		function(){
			...
			$("input[type=button][value=提交]").click(function(){
				...
				if(confirm("是否确认修改?")){
					$.ajax({
						type : "post",
						url : "modifyToolsType.htm",
						dataType : "json",
						data : {"zqlToolstypeModel.typeName":typeName,
							"zqlToolstypeModel.id":$(this).parent("span").find("input[name=identityId]").val()
						},
						success : function(data) { //成功后返回的页面
