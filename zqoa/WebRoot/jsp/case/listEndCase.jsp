			...
			<div class="toolbar">
				...
				<div id="toolbar-content">
					<p class="crumb">
						...
						<a href="listEndCase.htm">案件管理</a> >
						<a href="javascript:void(0);">案件列表</a>
					</p>
				...
				<fieldset class="forms-area">
					...
					<ec:table items="caselist" var="row"
							...
							<ec:row highlightRow="true">
								...
								<a href="caseDetail.htm?caseId=${row.id}" title="查看案件详情"><span id="number" >${row.number}</span></a>
								</ec:column>
								...
								<ec:column property="cust_typeValue" escapeAutoFormat="true"
									...
									<a href="${row.id}" title="出档">出档</a>|<a href="${row.id}" title="删除">删除</a>
								</ec:column>
